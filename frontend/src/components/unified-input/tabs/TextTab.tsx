  ...
  return (
    <div className="flex flex-col items-center gap-6">
      <div className="w-full max-w-lg">
        <div className="flex flex-col gap-6 p-8 border border-white/10 rounded-xl bg-white/5">
              ...
              <div className="flex flex-wrap gap-2">
                {EXAMPLE_PROMPTS.map((example, index) => (
                  <button
                    ...
                    className="text-xs px-2.5 py-1.5 rounded-full bg-white/10 text-gray-400 hover:bg-white/15 transition-colors truncate max-w-[200px]"
                    title={example}
                  >
